...
namespace QuantumTek.QuantumUI
{
    ...
    {
        private BalloonSpawnerScript balloonSpawnerScript;
        ...
        [HideInInspector] public static int optionIndex;
        [HideInInspector] public static string option;

        public void Awake()
        {
            SetOption(optionIndex);
            balloonSpawnerScript=GameObject.FindGameObjectWithTag("Spawner").GetComponent<BalloonSpawnerScript>();
            balloonSpawnerScript.setDifficulty(optionIndex);
        }
